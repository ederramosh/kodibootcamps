      ...
      <div className="max-w-3xl w-full">
        ...
        <div className="flex justify-end mb-4">
          <button
            ...
            className="bg-green-600 hover:bg-green-700 text-white font-semibold px-4 py-2 rounded-md shadow transition"
          >
            Registrar Bootcamp
          </button>
        </div>
        ...
        {/* Título */}
        <h2 className="text-3xl font-bold text-center text-white bg-indigo-600 py-4 rounded-md shadow mb-8">
          Bootcamps
        </h2>
        ...
        {/* Lista */}
        {data && data.length > 0 ? (
          <ul className="space-y-6 bg-indigo-600 p-6 rounded-lg shadow-inner">
            {data.map((bootcamp) => (
              <li
                key={bootcamp.created_at}
                className="bg-gradient-to-r from-indigo-100 to-purple-100 p-6 rounded-xl shadow-md border border-gray-300"
              >
